...
with open('POSCAR','r') as f: 
	...
	for i in range(0,10,2):
		...
		Sb = '  ' + str(round(b[0]*(1 + 0/100),6)) + '  ' + str(round(b[1]*(1 + 0/100),6)) + '  ' + str(round(b[2]*(1 + 0/100),6))
		Sc = '  ' + str(round(c[0]*(1 + i/100),6)) + '  ' + str(round(c[1]*(1 + i/100),6)) + '  ' + str(round(c[2]*(1 + i/100),6))
		namefile = 'POSCAR_'+str(i)
		with open (namefile, 'w') as f2:
			print(' La Fe O', file = f2)
			print(' 1.0', file = f2)
			print(Sa, file = f2)
			print(Sb, file = f2)
			print(Sc, file = f2)
			print('  La Fe O', file = f2)
			print('  4 4 12', file = f2)
