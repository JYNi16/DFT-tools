...
"""
@author: Jinyang Ni
# This script is coded for fitting the exchange parameters
# The input file E.dat including the energy values with 0 ~ Pi rotation angles.
"""
